...
public class MostrarCumpleanios extends JDialog {
	...
	private void inicializarVariables() {
		...
		jTableCumpleClientes.setPreferredScrollableViewportSize(new Dimension(530,95));
		
		//	Tamaño a las columnas
		jTableCumpleClientes.getColumnModel().getColumn(0).setMaxWidth(25);
		jTableCumpleClientes.getColumnModel().getColumn(0).setMinWidth(25);
		jTableCumpleClientes.getColumnModel().getColumn(0).setResizable(false);
		jTableCumpleClientes.getColumnModel().getColumn(1).setMaxWidth(40);
		jTableCumpleClientes.getColumnModel().getColumn(1).setMinWidth(40);
