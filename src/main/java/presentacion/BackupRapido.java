...
public class BackupRapido extends JFrame {
	...
	public BackupRapido() {
		...
		if (System.getenv("BackupRapido") != null) {
			nombreArchivo = "backup_" + new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
			userHomeFolder = System.getenv("BackupRapido");
			...
			JOptionPane.showMessageDialog( this, "La variable de entorno 'BackupRapido no se encuentra.'" , "Error", JOptionPane.ERROR_MESSAGE );
