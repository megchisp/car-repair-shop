...
//		/* Panel interior donde se muestran los automóviles que tiene el cliente */
	...
	private void inicializarVariables() {
		...
		jLabelNombreApellido.setText( stringApellidoCliente + ", " + stringNombreCliente );
		...
		tablaAutomovilesClientes.setPreferredScrollableViewportSize(new Dimension(555,95));
